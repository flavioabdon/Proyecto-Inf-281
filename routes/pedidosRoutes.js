...
router.post('/tomar_pedido_delivery', pedidosC.tomar_pedidos_delivery); //json enviar id_pedido, id_usuario
router.post('/delivery_en_casa', pedidosC.delivery_en_casa); //json enviar id_pedido
router.post('/confirmar_entrega', pedidosC.confirmar_entrega); //json enviar id_pedido
